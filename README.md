...
- **Self-service subject role** — `/pridatpredmet`. Prvé 2 žiadosti o predmetovú rolu za semester (guild+user) auto-grant, ďalšie čakajú na admin approval (free-text reject reason). ZS/LS pickery pri žiadosti vzájomne vylučujú už pridelené role druhého semestra.
